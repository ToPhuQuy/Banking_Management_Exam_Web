<div class="container-fluid py-3" id="footer">
    <div class="row">
        ...
        <div class="col-md">
            <h5>Karma</h5>
            <p class="text-justify">Assignment môn lập trình web - Xây dựng website quản lý ngân hàng câu hỏi đề thi
                trắc nghiệm, hỗ trợ
                quản lý & tạo lập đề thi</p>
        </div>
        <div class="col-md">
            <div class="row">
                <div class="col">
            ...
            <div class="row">
                <div class="col">
                    <a href="mailto: abc@example.com">Gửi mail cho chúng tôi</a>
                </div>
            </div>
        </div>
        <div class="col-md">
            ...
            <div class="row">
                <div class="col">
                    <p>
                        ...
                        <a href="https://quilljs.com/">QuillJs</a><br>
